...
class NotionDatabase():
    ...
    def upload_page_values(self, page_values, verbose=False):
        for property_key, property_value in page_values.items():
            print(property_key, property_value) if verbose else None
            ...
            elif self.property_dict[property_key] == "url":
                self.page_form["properties"][property_key][self.property_dict[property_key]] = property_value
            elif self.property_dict[property_key] == "multi_select":
                for value in property_value:
                    self.page_form["properties"][property_key][self.property_dict[property_key]].append({"name": value})
